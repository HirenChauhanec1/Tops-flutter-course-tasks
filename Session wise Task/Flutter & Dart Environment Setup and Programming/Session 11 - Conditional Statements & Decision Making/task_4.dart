void main() {
  ...
  // uses a switch statement to print a different message for each role,
  // like 'Admin: Access to all features', 'Seller: Can add products', 'Buyer: Can browse and purchase'.

  showRoleFeatures("seller");
}

void showRoleFeatures(String userRole) {
